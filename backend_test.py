...
class SimpleAPITester:
    def __init__(self, base_url="https://burgers-orsay.preview.emergentagent.com"):
...
def main():
    print("🚀 Starting Backend API Tests for Charlie Foods Restaurant")
    print("=" * 60)
    ...
    if not status_id:
        ...
        print(f"✅ Status check created with ID: {status_id}")
